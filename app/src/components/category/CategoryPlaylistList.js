...
export class CategoryPlaylistList extends Component {
  static contextTypes = {
    isMobile: React.PropTypes.bool.isRequired
  };

  renderRow(item, index, style) {
    return <CategoryPlaylistItem key={index} item={item} style={style} />;
  }
  ...
  render() {
    ...
    if (props.categoryId) {
      props.path = `category/${props.categoryId}/playlists`;
    }
